...
function contactWhatsApp(plan: string) {
  const msg = encodeURIComponent(
    `Hola, me gustaría contratar el plan ${plan} en Market EG. ¿Cómo puedo activarlo?`,
  );
    ...
    <View style={[styles.root, { paddingTop: insets.top }]}>
      ...
      <ScrollView
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            const msg = encodeURIComponent(
              'Hola, quiero destacar un anuncio en Market EG durante 7 días (1.000 XAF). ¿Cómo procedo?',
            );
